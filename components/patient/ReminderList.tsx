...
export function ReminderList({
  ...
  if (items.length === 0) {
    return <p className="text-xl text-muted">No reminders scheduled for today.</p>;
  }
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted">at {fmtTime(o.scheduledFor)}</p>
                  {o.description ? (
            ...
            {done ? (
              ...
              <div className="mt-4 flex gap-3">
                ...
                >
                  <Clock3 className="h-6 w-6" /> Later
                </button>
              </div>
            )}
          </li>
